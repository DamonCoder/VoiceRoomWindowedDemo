 ...
 */
public class GlobalFloatingWindow extends RelativeLayout {
    ...
    public GlobalFloatingWindow(Context context) {
        super(context);
        init();
    }
...
//        mDefaultWidth = 210;
        ...
        View.inflate(getContext(), R.layout.widget_float_view, this);
        BreatheView bvFloatView = findViewById(R.id.bv_float_view);
        CircleImageView ivFloatView = findViewById(R.id.iv_float_view);
